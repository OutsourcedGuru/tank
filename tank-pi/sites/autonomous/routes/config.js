...
exports.defaultStraightSpeed =  255;      // 50 is approximately the minimum
exports.defaultCurveSpeed =     200;      // 80 is approximately the practical minimum
exports.reloadSeconds =         1;        // set to 3 for a race or 5 for training purposes with a slow default speed
exports.verbose =               false;    // in serial.js, allows calculations to continue after bStopped has been determined
exports.tankIsDown =            false;    // set this if you're just developing and the tank is expected to be offline
